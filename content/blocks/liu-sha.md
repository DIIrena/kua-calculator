...
Liu Sha is the third of your four cautious directions. Its name, *Liu Sha* (六煞), translates as "Six Killings." The name is alarming; the thing it describes is not. For you, {{firstName}}, it points **{{direction}}**.
...
Some rooms decide for you. The window is on one wall, the door on another, the radiator on a third, and there is exactly one place the bed fits. If that place points the headboard at {{direction}}, the honest answer is not to wrestle the furniture into a spot it cannot go. You work with what the room allows, and you reach first for a different lever.
...
A bed pointed {{direction}} with those softeners is not the same as a bed on a favourable wall, and the tradition is honest about that. It is also not the same as the bare-wall version, and the difference is real and takes an afternoon.
