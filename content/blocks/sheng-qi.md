...
Sheng Qi is not the right direction for everything. The tradition reads a Sheng Qi bed as energising, which is exactly the wrong thing for someone who needs deep rest more than a push. For that, practitioners point the bed to **Tian Yi**, the healing direction, which is the next chapter. Many Classical practitioners default the bed to Tian Yi for *most* of life and switch to Sheng Qi only during seasons that need momentum. Both are correct readings. The question is which season you are in.
