...
So far this corner is the same for everyone, because Southeast is a fixed sector. Your Kua number adds a personal layer on top of it, and this is where the reading becomes yours.

Your Kua number is **{{kuaNumber}}**, which places you in the **{{kuaGroup}} group**. That group gives you four supportive directions and four to handle with care. The move here is simple: **check which list your Southeast falls into.**

- **If Southeast is one of your four supportive directions** ({{shengQiDir}}, {{tianYiDir}}, {{yanNianDir}}, or {{fuWeiDir}}), then the fixed wealth corner and one of your personal good directions sit in the same place. That overlap reads as doubly strong for you, and this corner becomes a natural spot to spend time, to place your chair so your body faces into it, or to sit for focused work.
- **If Southeast is one of your four cautious directions** ({{huoHaiDir}}, {{wuGuiDir}}, {{liuShaDir}}, or {{jueMingDir}}), the corner does not stop being your wealth sector. It still wants the same care, light, and clearing. The adjustment is gentle: tend it, keep it clean and uncluttered, but do not make it the corner you sit facing for hours or anchor your most important work toward. Treat it with care rather than treating it as your power seat.

Either way, the maintenance is identical. The clutter still goes, the light still comes up, the broken things still get fixed. The Kua overlay only changes how much you lean *into* the corner, not whether you care for it.

To find which of your directions Southeast matches, compare the compass bearing you walked earlier against your personal direction list. If Southeast and one of your supportive directions point to the same wall, you have the doubled reading. If it lines up with a cautious one, you have the handle-with-care reading. Most people land in one camp or the other, and both are workable.
...
The plant, the water, and the Kua-aware seating are refinements you can layer on once the corner is clear. None of them is a guarantee, and none of them is the point. The point is a corner you tend rather than avoid, in the one fixed sector long tied to flow.
