...
Nine chapters offer more moves than any one week should hold. So choose like a practitioner:

1. **Clear the Centre first.** The health chapter's rule is the whole book's rule: the middle of the home touches every area at once, so an open, cared-for centre is the one move that helps all nine. If you do nothing else this week, do that.
2. **Then go to the area that stung.** You know which chapter you read twice. Make its recap-card move, just that one, and live with it for seven days.
3. **Lean green, tend orange.** Where your verdict map is green, you can commit: place the desk, anchor the chair, spend the time. Where it is soft orange, keep the corner clean and lit, and let your supportive directions carry the anchoring instead.

Notice, without forcing the question, whether the room feels different after a week. If it does, keep the change. If it does not, you have lost only minutes, and the map still holds eight more places to try.

## If you want the whole instrument
