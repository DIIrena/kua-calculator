...
If you have an afternoon, run the [14-point room harmony checklist](/checklist). It walks you through one of the most universally-safe lists in the practice. None of the questions need a compass. None of them need furniture.

If you want the deeper read, the [bagua map article](/articles/bagua-map-wealth-corner) is the next door in.
