...
If the evidence-aware version of feng shui interests you, the [twenty-six universal-safe changes article](/articles/twenty-six-changes-this-weekend) is the place to start. Every move on that list is a type-1 or type-2 claim; none are pure type-3.

If you want a longer reading of the practical / mystical divide, the article on [feng shui or just good design](/articles/feng-shui-or-good-design) walks through it from the other side.

And if you want to actually run an experiment in your own home, the [five tests article](/articles/five-tests-you-can-run) lays out five small testable interventions you can run this week with a notebook.
