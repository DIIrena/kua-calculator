...
<figure>
<svg viewBox="0 0 480 480" role="img" aria-label="A simplified three-ring luopan diagram. The outermost ring carries the eight trigrams in pinyin: Kan at north, Gen at northeast, Zhen at east, Xun at southeast, Li at south, Kun at southwest, Dui at west, Qian at northwest. The middle ring carries the eight compass directions N, NE, E, SE, S, SW, W, NW. The innermost ring carries the five elements at their associated directions: Water at north, Earth at northeast and southwest, Wood at east and southeast, Fire at south, Metal at west and northwest. A small central well holds a compass needle pointing to N." xmlns="http://www.w3.org/2000/svg">
  <rect x="0" y="0" width="480" height="480" fill="#f4ede2"/>
  <circle cx="240" cy="240" r="220" fill="#f4ede2" stroke="#2b261f" stroke-width="2"/>
  <circle cx="240" cy="240" r="160" fill="#f4ede2" stroke="#2b261f" stroke-width="1.5"/>
  <circle cx="240" cy="240" r="100" fill="#f4ede2" stroke="#2b261f" stroke-width="1.5"/>
  <circle cx="240" cy="240" r="40" fill="#e8d4c0" stroke="#2b261f" stroke-width="1.5"/>
  <g stroke="#2b261f" stroke-width="1" opacity="0.6">
    <line x1="240" y1="20" x2="240" y2="460"/>
    <line x1="20" y1="240" x2="460" y2="240"/>
    <line x1="84" y1="84" x2="396" y2="396"/>
    <line x1="396" y1="84" x2="84" y2="396"/>
  </g>
  <g font-family="inherit" text-anchor="middle" fill="#2b261f" font-size="14" font-weight="600">
    <text x="240" y="40">Kan</text>
    <text x="395" y="92">Gen</text>
    <text x="450" y="245">Zhen</text>
    <text x="395" y="400">Xun</text>
    <text x="240" y="455">Li</text>
    <text x="80" y="400">Kun</text>
    <text x="30" y="245">Dui</text>
    <text x="80" y="92">Qian</text>
  </g>
  <g font-family="inherit" text-anchor="middle" fill="#5e7355" font-size="13">
    <text x="240" y="105">N</text>
    <text x="335" y="146">NE</text>
    <text x="375" y="245">E</text>
    <text x="335" y="345">SE</text>
    <text x="240" y="385">S</text>
    <text x="145" y="345">SW</text>
    <text x="105" y="245">W</text>
    <text x="145" y="146">NW</text>
  </g>
  <g font-family="inherit" text-anchor="middle" fill="#b06a45" font-size="12" font-style="italic">
    <text x="240" y="165">water</text>
    <text x="295" y="195">earth</text>
    <text x="315" y="245">wood</text>
    <text x="295" y="298">wood</text>
    <text x="240" y="325">fire</text>
    <text x="185" y="298">earth</text>
    <text x="165" y="245">metal</text>
    <text x="185" y="195">metal</text>
  </g>
  <g>
    <polygon points="240,210 232,245 240,238 248,245" fill="#b06a45" stroke="#2b261f" stroke-width="1"/>
    <polygon points="240,270 232,235 240,242 248,235" fill="#2b261f" stroke="#2b261f" stroke-width="1"/>
    <text x="240" y="277" font-family="inherit" text-anchor="middle" font-size="10" fill="#2b261f" font-weight="600">N</text>
  </g>
</svg>
<figcaption>Simplified three-ring luopan showing the most basic Compass School information layers: trigrams (outer), compass directions (middle), and elements (inner). A real luopan carries many more rings encoding 24 Mountains, heavenly stems and earthly branches, hexagrams, and sub-school-specific data.</figcaption>
</figure>
...
<figure>
<svg viewBox="0 0 480 480" role="img" aria-label="An eight-direction Bagua diagram drawn as a circle divided into eight equal sectors. Each sector is labelled with the direction abbreviation, trigram name in pinyin, and associated element. Starting from the top and reading clockwise: North (Kan, water), Northeast (Gen, earth), East (Zhen, wood), Southeast (Xun, wood), South (Li, fire), Southwest (Kun, earth), West (Dui, metal), Northwest (Qian, metal). A small compass needle in the centre indicates north." xmlns="http://www.w3.org/2000/svg">
  <rect x="0" y="0" width="480" height="480" fill="#f4ede2"/>
  <circle cx="240" cy="240" r="200" fill="#f4ede2" stroke="#2b261f" stroke-width="2"/>
  <g stroke="#2b261f" stroke-width="1.5" opacity="0.7">
    <line x1="240" y1="40" x2="240" y2="440"/>
    <line x1="40" y1="240" x2="440" y2="240"/>
    <line x1="98" y1="98" x2="382" y2="382"/>
    <line x1="382" y1="98" x2="98" y2="382"/>
  </g>
  <g font-family="inherit" text-anchor="middle" fill="#2b261f">
    <g>
      <text x="240" y="80" font-size="14" font-weight="600">N</text>
      <text x="240" y="100" font-size="12">Kan</text>
      <text x="240" y="118" font-size="11" font-style="italic" fill="#5e7355">water</text>
    </g>
    <g>
      <text x="356" y="124" font-size="14" font-weight="600">NE</text>
      <text x="356" y="144" font-size="12">Gen</text>
      <text x="356" y="162" font-size="11" font-style="italic" fill="#5e7355">earth</text>
    </g>
    <g>
      <text x="400" y="240" font-size="14" font-weight="600">E</text>
      <text x="400" y="260" font-size="12">Zhen</text>
      <text x="400" y="278" font-size="11" font-style="italic" fill="#5e7355">wood</text>
    </g>
    <g>
      <text x="356" y="356" font-size="14" font-weight="600">SE</text>
      <text x="356" y="376" font-size="12">Xun</text>
      <text x="356" y="394" font-size="11" font-style="italic" fill="#5e7355">wood</text>
    </g>
    <g>
      <text x="240" y="400" font-size="14" font-weight="600">S</text>
      <text x="240" y="420" font-size="12">Li</text>
      <text x="240" y="438" font-size="11" font-style="italic" fill="#b06a45">fire</text>
    </g>
    <g>
      <text x="124" y="356" font-size="14" font-weight="600">SW</text>
      <text x="124" y="376" font-size="12">Kun</text>
      <text x="124" y="394" font-size="11" font-style="italic" fill="#5e7355">earth</text>
    </g>
    <g>
      <text x="80" y="240" font-size="14" font-weight="600">W</text>
      <text x="80" y="260" font-size="12">Dui</text>
      <text x="80" y="278" font-size="11" font-style="italic" fill="#5e7355">metal</text>
    </g>
    <g>
      <text x="124" y="124" font-size="14" font-weight="600">NW</text>
      <text x="124" y="144" font-size="12">Qian</text>
      <text x="124" y="162" font-size="11" font-style="italic" fill="#5e7355">metal</text>
    </g>
  </g>
  <circle cx="240" cy="240" r="30" fill="#e8d4c0" stroke="#2b261f" stroke-width="1.5"/>
  <polygon points="240,215 232,245 240,240 248,245" fill="#b06a45" stroke="#2b261f" stroke-width="1"/>
  <polygon points="240,265 232,235 240,240 248,235" fill="#2b261f" stroke="#2b261f" stroke-width="1"/>
</svg>
<figcaption>The eight directions with their Later Heaven Bagua trigrams and elements. The arrangement is symmetrical, with the two metal directions (W and NW) facing the two wood directions (E and SE), and water (N) facing fire (S).</figcaption>
</figure>
