...
The bed is for sleep. The room asks for the conditions that match. For where the bed sits in the room, see [the bedroom, kitchen, and front-door layout page](/guide/rooms/bedroom-kitchen-front-door).

For a short reset that walks the bedroom through air, light, sound, and surface in sequence, the [bedroom reset](/products/bedroom-reset) is in waitlist.
...
The structural containment principle is taught on [the bathrooms and problem rooms page](/guide/rooms/bathrooms-storage-problem-rooms). This is the physical-health echo of the same moves.
...
- The framing for the whole cluster: [healthy-home feng shui: air, light, damp, and rest](/guide/healthy-home/healthy-home-feng-shui-without-health-promises).
