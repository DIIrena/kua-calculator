...
- Ten seconds: try [the Kua calculator](/kua-calculator).
- An afternoon: pair [the room by room element cures page](/guide/cures/five-element-cures-room-by-room) with [the page on how to read any room](/guide/rooms/how-to-read-any-room).
- Deeper read: see [the methodology page](/methodology).
- The annual layer: read [the page on annual cures vs permanent fixes](/guide/cures/annual-cures-vs-permanent-fixes).
