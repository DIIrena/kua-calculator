...
The underlying element vocabulary sits one layer beneath all six families. For that, see [the five elements as a design language](/guide/five-elements/five-elements-as-a-design-language). The close-up walkthrough on the five most-used families (mirrors split out from Light for its own treatment, plus plants, light, sound, and symbols) lives on [the cure families page](/guide/cures/mirrors-plants-light-sound-and-symbols).
...
To pick the sector you need to know which room you are reading. [The how-to-read-any-room page](/guide/rooms/how-to-read-any-room) is the diagnostic this page assumes. To pick the element for that sector, [the room-by-room element cures page](/guide/cures/five-element-cures-room-by-room) is the next step.
...
- **Ten seconds.** Find your trigram with [the Kua calculator](/kua-calculator).
- **An afternoon.** Walk your home with [the how-to-read-any-room page](/guide/rooms/how-to-read-any-room) open, then read [the cure families page](/guide/cures/mirrors-plants-light-sound-and-symbols).
- **The element vocabulary.** Read [the five elements as a design language](/guide/five-elements/five-elements-as-a-design-language) and [the productive and controlling cycles](/guide/five-elements/the-productive-and-controlling-cycles).
- **The annual layer.** See [the page on annual cures versus permanent fixes](/guide/cures/annual-cures-vs-permanent-fixes).
- **Deeper read.** See [the methodology page](/methodology) for how the cluster fits together.
