...
The vocabulary on this page feeds straight into the diagnostic. The next page, [how to read a room in element terms](/guide/five-elements/reading-a-room-in-element-terms), gives you four questions that turn the vocabulary into a read of any room you walk into. After that, [the two cycles that do the practical work](/guide/five-elements/the-productive-and-controlling-cycles) tells you what to add and which route to take.
...
- **Ten seconds.** [Find your Kua number](/kua-calculator) so you know which directions and elements the tradition associates with you.
- **An afternoon.** Read [how to read a room in element terms](/guide/five-elements/reading-a-room-in-element-terms), then [the two cycles that do the practical work](/guide/five-elements/the-productive-and-controlling-cycles).
- **Deeper read.** The [methodology](/methodology) page walks through the formulas and the Bagua table.
