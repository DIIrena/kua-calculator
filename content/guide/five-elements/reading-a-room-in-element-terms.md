...
The same materials read differently depending on the room's job. A [bedroom](/space/bedroom) wants more Earth. The tradition supports the conditions for *rest*, and Earth is the stabilising, quieting element. Literal water features are conventionally kept out of the bedroom, even though stillness is the goal. A [kitchen](/space/kitchen) already has Fire and Metal in the stove and cookware. The question is usually what balances them, not what to add. A [living room](/space/living-room) wants Fire for warmth and company, supported by Wood for growth and life. The tradition associates Fire with gathering and expression. An office wants Metal and Wood - clarity plus growth. Dining rooms, bathrooms, and terraces have their own logic on the [room pages](/space/dining-room).
...
1. Ten seconds: a [Kua number](/kua-calculator) tells you which of the Five Elements the tradition associates with you personally. That is the layer this diagnostic does not cover.
2. An afternoon: read [the cycles page](/guide/five-elements/the-productive-and-controlling-cycles), then loop back to the [design-language page](/guide/five-elements/five-elements-as-a-design-language) for the materials vocabulary.
3. Deeper read: the [methodology](/methodology) page walks through the formulas and the full Bagua table. The [2026 Planner](/products/annual-feng-shui-planner-2026) is the same diagnostic extended across the year, sector by sector, when you want the timing layer.
