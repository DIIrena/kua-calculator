...
For the natal-side sibling, see [the BaZi page on birth data and personal timing](/guide/sister-disciplines/bazi-birth-data-and-personal-timing). For the objects-side sibling, see [the page on crystals, symbols, and optional tools that sit beside feng shui](/guide/sister-disciplines/crystals-symbols-and-optional-tools).
