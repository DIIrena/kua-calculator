...
This is the load-bearing paragraph. BaZi reads the person. Feng shui reads the place. Together, a practitioner arranges the place to support the person. The Kua number arranges space and lives entirely on [the Compass School side of feng shui](/guide/compass-school/what-is-compass-school). If you want the personal layer that belongs to feng shui itself, use [the feng-shui-side Kua calculator, which arranges space rather than reading the person](/kua-calculator). For the broader frame, see [what feng shui itself reads](/guide/foundations/what-feng-shui-is-plainly). BaZi is its own discipline with its own apparatus and is not a feng shui tool.
...
Return to [where feng shui ends and the sister disciplines begin](/guide/sister-disciplines/what-belongs-to-feng-shui-and-what-sits-beside-it) for the overview. The timing sibling of this discipline is covered on [the page on Qi Men Dun Jia as date selection and strategic movement](/guide/sister-disciplines/qi-men-dun-jia-date-selection-and-strategy), which reads the moment rather than the person.
