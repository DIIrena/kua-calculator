...
Past pulling furniture off the wall and adding a warm lamp below eye height (those starter moves are at [the living room page](/space/living-room)), the deeper work is **zones**.
...
The whole-room bagua overlay is worth running once. Stand at the doorway, line up the nine-area grid to the room, and notice which sector your main seat sits in versus which sector has gone empty. The walkthrough is at [the nine life areas](/guide/bagua/the-nine-life-areas). One pass tells you more than a year of rearranging.
...
Past the head-of-household facing the door, the question of whether a mirror belongs in the room at all, and the once-a-week ritual (covered at [the dining room page](/space/dining-room)), the deeper work is the table itself.
...
Number of chairs is worth a moment of intention. Six is balanced and social. Eight is generous. Four is intimate. If you know your *kua* ("trigram") group, you can pick chair count and finishing material to match your supportive element. The [five tests at the articles page](/articles/five-tests-you-can-run) are a good gut check after.
...
The walkthrough method that pulls all of this together is at [how to read any room](/guide/rooms/how-to-read-any-room). The three highest-stakes rooms sit at [bedroom, kitchen, and front door](/guide/rooms/bedroom-kitchen-front-door). When beams, awkward shapes, or rooms with two jobs come up, see [bathrooms, storage, and problem rooms](/guide/rooms/bathrooms-storage-problem-rooms).

## Where to go next

- Ten seconds. [The Kua calculator](/kua-calculator).
- An afternoon. [Bathrooms, storage, and problem rooms](/guide/rooms/bathrooms-storage-problem-rooms) to walk the leakage and awkward cases.
- Deeper read. [The methodology page](/methodology).
