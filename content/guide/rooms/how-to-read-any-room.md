...
The sector lens reads each room against the nine areas of life. Start at [the nine life areas](/guide/bagua/the-nine-life-areas) when you want to know which corner is asking for attention.

The personal-direction lens reads furniture against the directions that support the person using it. Find your supportive direction at the [kua calculator](/kua-calculator), then start at [three orientations](/guide/compass-school/three-orientations) when you want to know which way the bed, the chair, and the door should face.

The elements lens reads materials, shapes, and feel. Start at [the deep element-language version of a single-room read](/guide/five-elements/reading-a-room-in-element-terms) when you want to slow down inside one room.
...
**Ten seconds.** Find the direction that supports you at the [kua calculator](/kua-calculator).

**An afternoon.** Walk [the three highest-stakes rooms](/guide/rooms/bedroom-kitchen-front-door) tonight, then take the active-use rooms in [living, dining, and home office](/guide/rooms/living-dining-home-office), and close with [bathrooms, storage, and problem rooms](/guide/rooms/bathrooms-storage-problem-rooms).

**Deeper read.** See how the practice is structured at [methodology](/methodology).
