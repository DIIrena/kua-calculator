There are two ways to lay the *Bagua* (the eight-sector map) over a home. The choice is the single largest practical divide in feng shui. Here is how to choose.
...
- **Ten seconds.** Find your personal direction with the [kua calculator](/kua-calculator).
- **An afternoon.** Read [what to do when the floor plan is not a clean rectangle](/guide/bagua/missing-corners-and-irregular-homes), or see [a worked example using the compass method on the wealth corner](/articles/bagua-map-wealth-corner).
- **Deeper read.** Open the [methodology](/methodology) for the bearing math, and revisit [what the map layer actually is](/guide/bagua/what-the-bagua-is) once the orientation has settled.
