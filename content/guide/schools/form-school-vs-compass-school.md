...
- **Ten seconds.** [Find your Kua number](/kua-calculator) so the Compass layer has something personal to attach to.
- **An afternoon.** Read [what Compass School actually covers](/guide/compass-school/what-is-compass-school) for the four Compass sub-schools, then [Flying Stars, BTB, and when timing enters the picture](/guide/schools/flying-stars-btb-and-timing) for the calendar layer.
- **Deeper read.** Work through [the methodology page](/methodology) for the luopan, the 24 Mountains, and the Eight Mansions worked examples.
