...
- **Ten seconds.** [Find your Kua number](/kua-calculator) for the personal directional layer Flying Stars layers time on top of.
- **An afternoon.** Read [the practical compass vs front-door choice for laying the Bagua](/guide/bagua/compass-vs-front-door-methods), then revisit [Form School versus Compass School](/guide/schools/form-school-vs-compass-school) for the foundational divide this page sits on top of, and [the four feng shui schools map](/guide/schools/four-feng-shui-schools-in-one-map) if the lineage names need refreshing.
- **Deeper read.** Work through [the methodology page](/methodology) for the Compass School mechanics Flying Stars sits on top of.
- **The annual layer.** [The 2026 Annual Feng Shui Planner](/products/annual-feng-shui-planner-2026) tracks the visiting stars year by year if you want a single place to hold them.
