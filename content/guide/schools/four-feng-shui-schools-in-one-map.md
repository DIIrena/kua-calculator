...
The next page sharpens the foundational divide between Form School and Compass School, the two halves of Classical practice. The page after that picks up Flying Stars and BTB together, because both sit outside the Form-and-Compass core for different reasons. If you want the prior layer first, [the foundations page on what feng shui actually is](/guide/foundations/what-feng-shui-is-plainly) sets the ground. If you want the four Compass sub-schools by name, [what Compass School is](/guide/compass-school/what-is-compass-school) carries the roster.

## Where to go next

- **Ten seconds.** [Find your Kua number](/kua-calculator) on the Kua calculator. The personal directional layer most readers meet first.
- **An afternoon.** Read [Form School versus Compass School](/guide/schools/form-school-vs-compass-school) for the foundational divide, then [Flying Stars, BTB, and when timing enters the picture](/guide/schools/flying-stars-btb-and-timing) for the calendar layer and the alternate lineage.
- **Deeper read.** Work through [the methodology page](/methodology) for the Compass School mechanics this map only names.
