...
export async function POST(req: NextRequest) {
  ...
  const sessionParams = (withTax: boolean) => ({
    ...
    custom_text: {
      submit: {
        message:
          "Digital downloads, delivered immediately by email. By purchasing you agree to immediate delivery and waive the EU 14-day withdrawal right. Full terms: myfengshuihome.com/legal.",
      },
    },
  });
