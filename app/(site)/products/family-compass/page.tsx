...
export const metadata: Metadata = {
  title: "Family Compass | My Feng Shui Home",
  description:
    "Your family corner (the East) read for your Kua: the sector the tradition ties to roots, household, and new growth. A short personalised PDF, $7.",
  alternates: {
    canonical: "https://myfengshuihome.com/products/family-compass",
  },
  openGraph: {
    type: "website",
...
export default async function FamilyCompassPage(props: {
    ...
    <div className="page-content product-page">
      <section className="product-hero">
        ...
        <h1 className="product-heading">
          The <em>Family Compass</em>.
        </h1>
        <p className="product-lede">Your family corner (the East) read for your Kua: the sector the tradition ties to roots, household, and new growth.</p>
      ...
      <ProductPreview slug="family-compass" title="Family Compass" />
      ...
      <FulfillmentBlock slug="family-compass" />
