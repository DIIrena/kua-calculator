...
export const metadata: Metadata = {
  title: "Career Compass | My Feng Shui Home",
  description:
    "Your career corner (the North) read for your Kua: the sector the tradition ties to your path and work, kept clear and moving. A short personalised PDF, $7.",
  alternates: {
    canonical: "https://myfengshuihome.com/products/career-compass",
  },
  openGraph: {
    type: "website",
...
export default async function CareerCompassPage(props: {
    ...
    <div className="page-content product-page">
      <section className="product-hero">
        ...
        <h1 className="product-heading">
          The <em>Career Compass</em>.
        </h1>
        <p className="product-lede">Your career corner (the North) read for your Kua: the sector the tradition ties to your path and work, kept clear and moving.</p>
      ...
      <ProductPreview slug="career-compass" title="Career Compass" />
      ...
      <FulfillmentBlock slug="career-compass" />
