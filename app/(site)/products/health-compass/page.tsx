...
export const metadata: Metadata = {
  title: "Health Compass | My Feng Shui Home",
  description:
    "Your health centre (the middle of the home) read for your Kua: the heart that touches every area, kept open and clear. A short personalised PDF, $7.",
  alternates: {
    canonical: "https://myfengshuihome.com/products/health-compass",
  },
  openGraph: {
    type: "website",
...
export default async function HealthCompassPage(props: {
    ...
    <div className="page-content product-page">
      <section className="product-hero">
        ...
        <h1 className="product-heading">
          The <em>Health Compass</em>.
        </h1>
        <p className="product-lede">Your health centre (the middle of the home) read for your Kua: the heart that touches every area, kept open and clear.</p>
      ...
      <ProductPreview slug="health-compass" title="Health Compass" />
      ...
      <FulfillmentBlock slug="health-compass" />
