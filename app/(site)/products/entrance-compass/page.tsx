...
export const metadata: Metadata = {
  title: "Entrance Compass | My Feng Shui Home",
  description:
    "Your front door and entrance read for your Kua: the approach, the threshold, and the first few steps in. A short personalised PDF, $7.",
  alternates: {
    canonical: "https://myfengshuihome.com/products/entrance-compass",
  },
  openGraph: {
    type: "website",
...
export default async function EntranceCompassPage(props: {
    ...
    <div className="page-content product-page">
      <section className="product-hero">
        ...
        <h1 className="product-heading">
          The <em>Entrance Compass</em>.
        </h1>
        <p className="product-lede">Your front door and entrance read for your Kua: the approach, the threshold, and the first few steps in.</p>
      ...
      <ProductPreview slug="entrance-compass" title="Entrance Compass" />
      ...
      <section className="product-section">
        ...
        <p>
          ...
          decide, so the entrance starts working with you.
        </p>
      </section>

      <FulfillmentBlock slug="entrance-compass" />
