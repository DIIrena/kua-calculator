...
export const metadata: Metadata = {
  title: "Living Room Compass | My Feng Shui Home",
  description:
    "Your living room read for your Kua: the main seat in command position, the conversation circle, and the corner to keep clear. A short personalised PDF, $7.",
  alternates: {
    canonical: "https://myfengshuihome.com/products/living-room-compass",
  },
  openGraph: {
    type: "website",
...
export default async function LivingRoomCompassPage(props: {
    ...
    <div className="page-content product-page">
      <section className="product-hero">
        ...
        <h1 className="product-heading">
          The <em>Living Room Compass</em>.
        </h1>
        <p className="product-lede">Your living room read for your Kua: the main seat in command position, the conversation circle, and the corner to keep clear.</p>
      ...
      <ProductPreview slug="living-room-compass" title="Living Room Compass" />
      ...
      <section className="product-section">
        ...
        <p>
          ...
          decide, so the living room starts working with you.
        </p>
      </section>

      <FulfillmentBlock slug="living-room-compass" />
      ...
      <section className="product-buy-section">
        ...
        <BuyButton
          productSlug="living-room-compass"
          priceLabel="$7"
          state="stripe-live"
