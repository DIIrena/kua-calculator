...
export const metadata: Metadata = {
  title: "Kitchen Compass | My Feng Shui Home",
  description:
    "Your kitchen read for your Kua: the stove, the cook's position, and the supportive direction to face while you work. A short personalised PDF, $7.",
  alternates: {
    canonical: "https://myfengshuihome.com/products/kitchen-compass",
  },
  openGraph: {
    type: "website",
...
export default async function KitchenCompassPage(props: {
    ...
    <div className="page-content product-page">
      <section className="product-hero">
        ...
        <h1 className="product-heading">
          The <em>Kitchen Compass</em>.
        </h1>
        <p className="product-lede">Your kitchen read for your Kua: the stove, the cook's position, and the supportive direction to face while you work.</p>
      ...
      <ProductPreview slug="kitchen-compass" title="Kitchen Compass" />
      ...
      <section className="product-section">
        ...
        <p>
          ...
          decide, so the kitchen starts working with you.
        </p>
      </section>

      <FulfillmentBlock slug="kitchen-compass" />
