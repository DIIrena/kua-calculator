...
export const metadata: Metadata = {
  title: "Creativity Compass | My Feng Shui Home",
  description:
    "Your creativity corner (the West) read for your Kua: the sector the tradition ties to projects, children, and play. A short personalised PDF, $7.",
  alternates: {
    canonical: "https://myfengshuihome.com/products/creativity-compass",
  },
  openGraph: {
    type: "website",
...
export default async function CreativityCompassPage(props: {
    ...
    <div className="page-content product-page">
      <section className="product-hero">
        ...
        <h1 className="product-heading">
          The <em>Creativity Compass</em>.
        </h1>
        <p className="product-lede">Your creativity corner (the West) read for your Kua: the sector the tradition ties to projects, children, and play.</p>
      ...
      <ProductPreview slug="creativity-compass" title="Creativity Compass" />
      ...
      <FulfillmentBlock slug="creativity-compass" />
      ...
      <section className="product-buy-section">
        ...
        <BuyButton
          productSlug="creativity-compass"
          priceLabel="$7"
          state="stripe-live"
