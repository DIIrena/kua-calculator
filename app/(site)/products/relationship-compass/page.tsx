...
export const metadata: Metadata = {
  title: "Relationship Compass | My Feng Shui Home",
  description:
    "Your relationship corner (the Southwest) read for your Kua: the sector the tradition ties to partnership, and how to tend it. A short personalised PDF, $7.",
  alternates: {
    canonical: "https://myfengshuihome.com/products/relationship-compass",
  },
  openGraph: {
    type: "website",
...
export default async function RelationshipCompassPage(props: {
    ...
    <div className="page-content product-page">
      <section className="product-hero">
        ...
        <h1 className="product-heading">
          The <em>Relationship Compass</em>.
        </h1>
        <p className="product-lede">Your relationship corner (the Southwest) read for your Kua: the sector the tradition ties to partnership, and how to tend it.</p>
      ...
      <ProductPreview slug="relationship-compass" title="Relationship Compass" />
      ...
      <FulfillmentBlock slug="relationship-compass" />
      ...
      <section className="product-buy-section">
        ...
        <BuyButton
          productSlug="relationship-compass"
          priceLabel="$7"
          state="stripe-live"
