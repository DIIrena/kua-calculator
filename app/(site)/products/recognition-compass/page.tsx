...
export const metadata: Metadata = {
  title: "Recognition Compass | My Feng Shui Home",
  description:
    "Your recognition corner (the South) read for your Kua: the sector the tradition ties to reputation, kept bright and clear. A short personalised PDF, $7.",
  alternates: {
    canonical: "https://myfengshuihome.com/products/recognition-compass",
  },
  openGraph: {
    type: "website",
...
export default async function RecognitionCompassPage(props: {
    ...
    <div className="page-content product-page">
      <section className="product-hero">
        ...
        <h1 className="product-heading">
          The <em>Recognition Compass</em>.
        </h1>
        <p className="product-lede">Your recognition corner (the South) read for your Kua: the sector the tradition ties to reputation, kept bright and clear.</p>
      ...
      <ProductPreview slug="recognition-compass" title="Recognition Compass" />
      ...
      <FulfillmentBlock slug="recognition-compass" />
      ...
      <section className="product-buy-section">
        ...
        <BuyButton
          productSlug="recognition-compass"
          priceLabel="$7"
          state="stripe-live"
