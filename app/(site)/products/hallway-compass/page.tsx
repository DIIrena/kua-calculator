...
export const metadata: Metadata = {
  ...
  description:
    "Your hallways read for your Kua: keeping pass-through space clear, lit, and unpinched, and slowing a long straight run. A short personalised PDF, $7.",
  alternates: {
    canonical: "https://myfengshuihome.com/products/hallway-compass",
  },
  openGraph: {
    type: "website",
...
export default async function HallwayCompassPage(props: {
    ...
    <div className="page-content product-page">
      ...
      <section className="product-section">
        ...
        <p>
          ...
          decide, so the hallway starts working with you.
        </p>
      </section>
