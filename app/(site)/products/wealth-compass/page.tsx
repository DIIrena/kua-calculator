...
export const metadata: Metadata = {
  title: "Wealth Compass | My Feng Shui Home",
  description:
    "Your wealth corner (the Southeast) read for your Kua: what the tradition gives this sector and how to find and tend yours. A short personalised PDF, $7.",
  alternates: {
    canonical: "https://myfengshuihome.com/products/wealth-compass",
  },
  openGraph: {
    type: "website",
...
export default async function WealthCompassPage(props: {
    ...
    <div className="page-content product-page">
      <section className="product-hero">
        ...
        <h1 className="product-heading">
          The <em>Wealth Compass</em>.
        </h1>
        <p className="product-lede">Your wealth corner (the Southeast) read for your Kua: what the tradition gives this sector and how to find and tend yours.</p>
      ...
      <ProductPreview slug="wealth-compass" title="Wealth Compass" />
      ...
      <FulfillmentBlock slug="wealth-compass" />
