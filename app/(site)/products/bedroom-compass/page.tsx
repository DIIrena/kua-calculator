...
export const metadata: Metadata = {
  title: "Bedroom Compass | My Feng Shui Home",
  description:
    "Your bedroom read for your Kua: the headboard wall in an ordinary season and a season of push, and the corners to keep for storage. A short personalised PDF, $7.",
  alternates: {
    canonical: "https://myfengshuihome.com/products/bedroom-compass",
  },
  openGraph: {
    type: "website",
...
export default async function BedroomCompassPage(props: {
    ...
    <div className="page-content product-page">
      <section className="product-hero">
        ...
        <h1 className="product-heading">
          The <em>Bedroom Compass</em>.
        </h1>
        <p className="product-lede">Your bedroom read for your Kua: the headboard wall in an ordinary season and a season of push, and the corners to keep for storage.</p>
      ...
      <ProductPreview slug="bedroom-compass" title="Bedroom Compass" />
      ...
      <section className="product-section">
        ...
        <p>
          ...
          decide, so the bedroom starts working with you.
        </p>
      </section>

      <FulfillmentBlock slug="bedroom-compass" />
