...
export const metadata: Metadata = {
  title: "Dining Room Compass | My Feng Shui Home",
  description:
    "Your table read for your Kua: where the head of the household sits, the seat for connection, and the seat with momentum. A short personalised PDF, $7.",
  alternates: {
    canonical: "https://myfengshuihome.com/products/dining-room-compass",
  },
  openGraph: {
    type: "website",
...
export default async function DiningRoomCompassPage(props: {
    ...
    <div className="page-content product-page">
      <section className="product-hero">
        ...
        <h1 className="product-heading">
          The <em>Dining Room Compass</em>.
        </h1>
        <p className="product-lede">Your table read for your Kua: where the head of the household sits, the seat for connection, and the seat with momentum.</p>
      ...
      <ProductPreview slug="dining-room-compass" title="Dining Room Compass" />
      ...
      <section className="product-section">
        ...
        <p>
          ...
          decide, so the dining room starts working with you.
        </p>
      </section>

      <FulfillmentBlock slug="dining-room-compass" />
      ...
      <section className="product-buy-section">
        ...
        <BuyButton
          productSlug="dining-room-compass"
          priceLabel="$7"
          state="stripe-live"
