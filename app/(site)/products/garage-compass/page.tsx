...
export const metadata: Metadata = {
  title: "Garage Compass | My Feng Shui Home",
  description:
    "Your garage or utility space read for your Kua: a heavy room suited to a cautious direction, kept ordered with a clean threshold. A short personalised PDF, $7.",
  alternates: {
    canonical: "https://myfengshuihome.com/products/garage-compass",
  },
  openGraph: {
    type: "website",
...
export default async function GarageCompassPage(props: {
    ...
    <div className="page-content product-page">
      <section className="product-hero">
        ...
        <h1 className="product-heading">
          The <em>Garage Compass</em>.
        </h1>
        <p className="product-lede">Your garage or utility space read for your Kua: a heavy room suited to a cautious direction, kept ordered with a clean threshold.</p>
      ...
      <ProductPreview slug="garage-compass" title="Garage Compass" />
      ...
      <section className="product-section">
        ...
        <p>
          ...
          decide, so the garage starts working with you.
        </p>
      </section>

      <FulfillmentBlock slug="garage-compass" />
