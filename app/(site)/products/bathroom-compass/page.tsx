...
export const metadata: Metadata = {
  title: "Bathroom Compass | My Feng Shui Home",
  description:
    "Your bathroom read for your Kua: why a draining room suits a cautious direction, and how to keep it dry, closed, and in order. A short personalised PDF, $7.",
  alternates: {
    canonical: "https://myfengshuihome.com/products/bathroom-compass",
  },
  openGraph: {
    type: "website",
...
export default async function BathroomCompassPage(props: {
    ...
    <div className="page-content product-page">
      <section className="product-hero">
        ...
        <h1 className="product-heading">
          The <em>Bathroom Compass</em>.
        </h1>
        <p className="product-lede">Your bathroom read for your Kua: why a draining room suits a cautious direction, and how to keep it dry, closed, and in order.</p>
      ...
      <ProductPreview slug="bathroom-compass" title="Bathroom Compass" />
      ...
      <section className="product-section">
        ...
        <p>
          ...
          decide, so the bathroom starts working with you.
        </p>
      </section>

      <FulfillmentBlock slug="bathroom-compass" />
