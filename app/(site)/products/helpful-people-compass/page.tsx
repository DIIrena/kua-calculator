...
export const metadata: Metadata = {
  title: "Helpful People Compass | My Feng Shui Home",
  description:
    "Your helpful-people corner (the Northwest) read for your Kua: the sector the tradition ties to mentors, support, and travel. A short personalised PDF, $7.",
  alternates: {
    canonical: "https://myfengshuihome.com/products/helpful-people-compass",
  },
  openGraph: {
    type: "website",
...
export default async function HelpfulPeopleCompassPage(props: {
    ...
    <div className="page-content product-page">
      <section className="product-hero">
        ...
        <h1 className="product-heading">
          The <em>Helpful People Compass</em>.
        </h1>
        <p className="product-lede">Your helpful-people corner (the Northwest) read for your Kua: the sector the tradition ties to mentors, support, and travel.</p>
      ...
      <ProductPreview slug="helpful-people-compass" title="Helpful People Compass" />
      ...
      <FulfillmentBlock slug="helpful-people-compass" />
      ...
      <section className="product-buy-section">
        ...
        <BuyButton
          productSlug="helpful-people-compass"
          priceLabel="$7"
          state="stripe-live"
