...
export const metadata: Metadata = {
  ...
  description:
    "The 2026 solar year read against your Kua: how the year's cautious and supportive corners fall on your own directions. A short personalised PDF, $9.",
  alternates: {
    canonical: "https://myfengshuihome.com/products/year-ahead-compass",
  },
  openGraph: {
    type: "website",
...
export default async function YearAheadCompassPage(props: {
    ...
    <div className="page-content product-page">
      ...
      <section className="product-section">
        ...
        <p>
          ...
          decide, so the year ahead starts working with you.
        </p>
      </section>
