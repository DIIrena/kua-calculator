// Reusable brand block: the SVG mark plus the "My Feng Shui Home" script
// wordmark in Bilbo Swash Caps. The SiteHeader has its own header-shaped
// variant; this one is laid out as a centered stand-alone block for use
// inside content pages (e.g. /account).

export default function BrandMark() {
  return (
    <div className="account-brand" aria-label="My Feng Shui Home">
      ...
      <span className="account-brand-script">My Feng Shui Home</span>
    </div>
  );
}
